...
from app.repository.psql_repository.messages_explosive_repository import insert_explosive_sentence_to_db
...
from app.utils.psql_sentences_utils import convert_data_to_person_model, \
    ...
    convert_data_to_suspicious_explosive_content_model


def insert_explosive_messages_db(data: dict):
    ...
    sentences_model = convert_data_to_suspicious_explosive_content_model(data['sentences'], person_id)
    insert_explosive_sentence_to_db(sentences_model)
